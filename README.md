...
- **文件上传功能**：支持通过 Dashboard 上传 Excel 数据文件，自动更新配置并刷新数据
- **Docker 部署**：提供完整的 Docker 部署方案，支持容器化运行、定时任务和配置文件双向同步
...
**注意**：货币对代码使用基准货币（如 EUR、JPY、HKD 等）作为键名。
