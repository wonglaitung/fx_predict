...
```bash
# 方式 1：从技能目录安装（推荐）
pip install -r .iflow/skills/md-to-word/requirements.txt
...
python3 .iflow/skills/md-to-word/scripts/md_to_word.py README.md

# 指定输出文件名
python3 .iflow/skills/md-to-word/scripts/md_to_word.py README.md --output README_word.docx

# 批量转换当前目录所有 Markdown 文件
python3 .iflow/skills/md-to-word/scripts/md_to_word.py *.md

# 批量转换指定目录
python3 .iflow/skills/md-to-word/scripts/md_to_word.py docs/*.md

# 递归处理子目录中的所有 Markdown 文件
python3 .iflow/skills/md-to-word/scripts/md_to_word.py . --recursive

# 查看完整帮助信息
python3 .iflow/skills/md-to-word/scripts/md_to_word.py --help
```
...
```bash
python3 .iflow/skills/md-to-word/scripts/md_to_word.py draft.md -o "Final Report v1.0.docx"
```
...
**依赖文件位置**：
```
.iflow/skills/md-to-word/requirements.txt
```

## 脚本位置

```
.iflow/skills/md-to-word/scripts/md_to_word.py
```
